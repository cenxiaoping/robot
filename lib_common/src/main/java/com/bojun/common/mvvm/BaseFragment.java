...
import com.bojun.common.util.NetUtil;
...
public abstract class BaseFragment extends SupportFragment implements IBaseView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initCommonView(mView);mView.setClickable(true);
        initView(mView);
        initListener();
        return mView;
    }
    ...
    private void lazyLoad() {
        ...
        LogPrintUtil.v("MYTAG", "lazyLoad start...");
        LogPrintUtil.v("MYTAG", "isViewCreated:" + isViewCreated);
        LogPrintUtil.v("MYTAG", "isViewVisable" + isViewVisable);
