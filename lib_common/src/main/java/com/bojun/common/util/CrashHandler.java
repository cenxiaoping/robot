...
import com.bojun.common.thread_pool.UiThreadPoolManager;
import com.bojun.net.BuildConfig;
import com.bojun.net.dto.RouteConstants;
import com.example.lib_utils.EnvironmentUtil;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        ...
        // 使用Toast来显示异常信息
        UiThreadPoolManager.getInstance().execute(new Runnable() {
            @Override
            public void run() {
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            LogPrintUtil.e(TAG, "Error while collect package info" + e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                if (DEBUG) {
                    LogPrintUtil.d(TAG, field.getName() + " : " + field.get(null));
                }
            } catch (Exception e) {
                LogPrintUtil.e(TAG, "Error while collect crash info" + e);
            }
        }
    }
